 ...
 * 
 * Revision: 
 *     Initial revision 1.1 11/16/2015 njd sst
 */
...
class Connect4FieldModel implements Connect4FieldInterface
{
	...
	Connect4FieldModel(char[][] board, Player aPlayer)
	{
		this.board = board;
	...
	public void dropPieces(int column, char gamePiece)
	{
		if(checkIfPiecedCanBeDroppedIn(column))
		{
			...
			else
			{
				...
				{
					if(board[row][column]==0 || board[row][column]=='#' || board[row][column]=='*' || board[row][column]=='$' || board[row][column]=='@'|| board[row][column]=='C')
						{
