...
public class Driver {
	...
	aHashSet.add("theSame");
	//System.out.println("SoMany : "+soMany+" size : "+aHashSet.size());
	...
	for ( int index = 0; index < MAX_ELEMENTS ; index ++ )	{
			if ( ! aHashSet.contains( allObjects[index] ) )
				{
				//System.out.println("========"+allObjects[index].hashCode());
				passed = false;
				}
	}
	...
	//System.out.println(" aHashSet.size() == soManyDifferentObjects "+ aHashSet.size()+"   ==  "+soManyDifferentObjects);
